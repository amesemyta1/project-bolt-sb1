...
export const OutcomesSection = (): JSX.Element => {
  // Data for outcome cards
  const outcomeCards = [
    {
      id: 1,
      title: "Stack real Bitcoin every time fans engage",
    },
    {
      id: 2,
      title: "Triple retention with quest‑based loops",
    },
    {
      id: 3,
      title: "Control first‑party data with zero acquisition tax",
    },
  ];
