  ...
  return (
    <section className="flex flex-col w-full max-w-[470px] items-start justify-center gap-5">
      <div className="flex flex-col items-start gap-10 w-full">
        <h2 className="w-full mt-[-0.75px] [font-family:'IBM_Plex_Mono',monospace] font-bold text-white text-4xl tracking-[0] leading-[normal]">
            ...
            <React.Fragment key={feature.id}>
              <div className="flex items-center gap-5 py-[15px] w-full">
                ...
                <div className="flex flex-col items-start justify-center gap-[5px] flex-1">
                  <h3 className="w-full mt-[-1.00px] [font-family:'IBM_Plex_Mono',monospace] font-bold text-[#f8c100] text-lg tracking-[0] leading-[normal]">
                    {feature.title}
                  </h3>

                  <p className="w-full [font-family:'IBM_Plex_Sans',sans-serif] font-semibold text-[#969696] text-lg tracking-[0] leading-[23.4px] whitespace-pre-line">
                    {feature.description}
                  </p>
                </div>
              </div>
